...
static int findCalibrationPart1(String line) {
    var numbers = line
        .chars()
        .filter(
            c -> c >= '0' && c <= '9'
...
static Integer getNumberAtIndex(String line, int i) {
...
static int findCalibrationPart2(String line) {
    int firstNumber = -1;
    int lastNumber = -1;
...
void main() {
    ...
    var calibration = bi
        .lines()
        .mapToInt(l -> findCalibrationPart2(l))
        .sum();
